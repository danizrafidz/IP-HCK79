...
export default function HomePage() {
  ...
  return (
    <>
      ...
      />
      <header className="bg-gray-900 pattern h-dvh">
        <div className="container px-6 mx-auto">
          <nav className="flex flex-col py-6 sm:flex-row sm:justify-between sm:items-center">
            <Link to="/">
              <HTGLogo styles="scale-120" />
            </Link>
            <div className="flex items-center mt-2 -mx-2 sm:mt-0">
              <Link
                to="/"
                className="px-3 py-1 text-sm font-semibold text-white transition-colors duration-300 transform border-2 border-primary rounded-md hover:bg-gray-700"
              >
                Sign In
              </Link>
              <Link
          ...
          <div className="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
            <div className="lg:w-1/2">
              <h2 className="text-3xl font-semibold text-gray-100 lg:text-4xl">
                Power Up Your Cyber Skills
              </h2>
              <h3 className="mt-2 text-2xl font-semibold text-gray-100">
                Hello <span className="text-primary">Guest</span>
              </h3>
              <p className="mt-4 text-gray-100">
                Empower your team with hands-on, gamified training that
                transforms cybersecurity skills from fundamentals to advanced
                threat defense. Build, train, and sustain high-performing cyber
                teams—ready to tackle real-world threats with confidence.
              </p>
            </div>
            <div className="flex mt-8 lg:w-1/2 lg:justify-end lg:mt-0">
              <div className="w-full max-w-md bg-base-300 rounded-lg dark:bg-gray-800 scale-120">
